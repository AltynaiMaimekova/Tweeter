# Generated by Django 3.2 on 2022-09-15 14:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subscription', models.ManyToManyField(related_name='followed_by', through='account.Subscription', to='account.UserProfile')),
